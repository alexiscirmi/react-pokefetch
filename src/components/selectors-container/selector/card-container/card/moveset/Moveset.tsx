        ...
        <div>
          ...
          {(movesetEffect[0].length + movesetEffect[1].length) > 180
            ? movesetEffect[0].length > 250
              ? <p className='me-1 sm:me-2 text-justify' style={{ fontSize: '10px' }}>{movesetEffect[0].slice(0, 250) + '...'}</p>
              : <p className='me-1 sm:me-2 text-justify' style={{ fontSize: '10px' }}>{movesetEffect[0]}</p>
        ...
        <div>
          ...
          {(movesetEffect[0].length + movesetEffect[1].length) > 180
            ? movesetEffect[1].length > 300
              ? <p className='me-1 sm:me-2 text-justify' style={{ fontSize: '10px' }}>{movesetEffect[1].slice(0, 300) + '...'}</p>
              : <p className='me-1 sm:me-2 text-justify' style={{ fontSize: '10px' }}>{movesetEffect[1]}</p>
